...
| **5** | Elaboração | 07/10/2026 | 13/10/2026 | - **Entrega da Unidade 2:** backlog do produto priorizado, MVP definido, DoR e DoD<br>- Matriz de rastreabilidade (OE → CP → VN → RF → RNF)<br>- Prova de conceito da custódia e do split de pagamento |
